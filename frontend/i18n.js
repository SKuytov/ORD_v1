...
const translations = {
    bg: {
        ...
        'order.create.partNumber': 'Партиден номер',
        'order.create.partNumber.placeholder': 'Ако е приложимо',
        'order.create.category': 'Категория',
        'order.create.category.placeholder': 'напр. Електрически материали, Инструменти...',
        ...
        'orders.quickFilter.due7': 'Нужни до 7 дни',
        'orders.quickFilter.due14': 'Нужни до 14 дни',
